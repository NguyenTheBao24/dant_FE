...
export function InvoiceDetailDialog({ isOpen, onClose, invoiceId }: InvoiceDetailDialogProps) {
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div>
                                        ...
                                        <p className="font-semibold">
                                            {invoiceDetails.breakdown.thang}/{invoiceDetails.breakdown.nam}
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-yellow-600">
                                                    {invoiceDetails.breakdown.chiSoDienCu} → {invoiceDetails.breakdown.chiSoDienMoi}
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-cyan-600">
                                                    {invoiceDetails.breakdown.chiSoNuocCu} → {invoiceDetails.breakdown.chiSoNuocMoi}
                                ...
                                {invoiceDetails.breakdown.tienDichVu > 0 && (
                                    <div className="flex justify-between items-center p-4 bg-purple-50 rounded-lg border border-purple-200">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <p className="font-medium text-purple-800">Dịch vụ dùng chung</p>

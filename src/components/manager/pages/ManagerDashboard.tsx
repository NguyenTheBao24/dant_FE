...
export function ManagerDashboard({ selectedHostel }: ManagerDashboardProps) {
    ...
    useEffect(() => {
        if (selectedHostel?.can_ho) {
            ...
            const occupied = selectedHostel.can_ho.filter((room: any) =>
    ...
    const renderActiveTab = () => {
        switch (activeTab) {
            case "overview":
                return <OverviewPage selectedHostel={selectedHostel} occupiedRoomsCount={occupiedRoomsCount} />
            case "tenants":
            ...
            case "reports":
                return (
                    <div className="flex items-center justify-center h-96">
                        <div className="text-center">
                            <h3 className="text-lg font-semibold text-gray-600 mb-2">Báo cáo</h3>
                            <p className="text-gray-500">Tính năng đang được phát triển</p>
                        </div>
                    </div>
                )
            case "settings":
                return (
                    <div className="flex items-center justify-center h-96">
                        <div className="text-center">
                            <h3 className="text-lg font-semibold text-gray-600 mb-2">Cài đặt</h3>
                            <p className="text-gray-500">Tính năng đang được phát triển</p>
                        </div>
                    </div>
                )

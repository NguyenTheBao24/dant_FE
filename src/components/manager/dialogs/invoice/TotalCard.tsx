...
import { InvoiceData, BangGia, RoomInfo } from "../../../../types/invoice.types"
            ...
            <CardContent className="p-4">
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center">
                        ...
                        <span className="text-lg font-semibold text-green-800">Tổng cộng</span>
                    </div>
                        ...
                        <span>
                            ...
                            {bangGia?.gia_dich_vu && (
                                <span className="text-xs text-gray-500 ml-1">
                                    ({(bangGia.gia_dich_vu).toLocaleString('vi-VN')}₫/tháng)
                                </span>
                            )}
                        </span>
                    </div>

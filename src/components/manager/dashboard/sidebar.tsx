        ...
        <div className="w-80 bg-white border-r border-gray-200 p-6 space-y-6">
                    ...
                    <CardContent className="p-4">
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium text-blue-600">{occupancyRate}%</span>
                            </div>
                        </div>
                    </CardContent>
                </Card>
            ...
            <div className="space-y-2">
                ...
                <Button
                    ...
                    className={`w-full justify-start h-12 transition-all duration-300 rounded-xl ${activeTab === "tenants"
                        ? "bg-blue-600 text-white shadow-lg hover:shadow-xl"
                        : "hover:bg-gray-100 hover:shadow-md"
                        }`}
                ...
                <Button
                    ...
                    className={`w-full justify-start h-12 transition-all duration-300 rounded-xl ${activeTab === "rooms"
                        ? "bg-blue-600 text-white shadow-lg hover:shadow-xl"
                        : "hover:bg-gray-100 hover:shadow-md"
                        }`}

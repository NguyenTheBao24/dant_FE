...
export async function getInvoiceDetails(invoiceId) {
    ...
    try {
        ...
        if (invoiceError) {
            console.error('Error fetching invoice details for ID:', invoiceId, invoiceError)
        ...
        const soKwh = (invoiceData.so_dien_moi || 0) - (invoiceData.so_dien_cu || 0)
        ...
        const tienPhong = (invoiceData.so_tien || 0) - tienDien - tienNuoc - tienDichVu
        ...
        return {
            ...
            breakdown,
            // Tính tổng để verify
            calculatedTotal: breakdown.tienPhong + breakdown.tienDien + breakdown.tienNuoc + breakdown.tienDichVu
        }
